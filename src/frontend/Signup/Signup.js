...
function Signup() {
    ...
    const signUpUser = () => {
        console.log("dfs"+user.password+"fdc"+confirmPassword)
        if(user.password != confirmPassword) {
            setErrmsg({...errmsg, password: 'Password Didn\'t match'})
        } else {
        ...
        <div className='signup-form'>
            <form>
                <div className='mb-3'>
                    ...
                    <input className='browse-file' type="file" accept="image/*" onChange={(e) =>  triggerBrowseFile(e)} />
                </div>
                <div className="mb-3">
